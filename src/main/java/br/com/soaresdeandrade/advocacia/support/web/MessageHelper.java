package br.com.soaresdeandrade.advocacia.support.web;

import static br.com.soaresdeandrade.advocacia.support.web.Message.MESSAGE_ATTRIBUTE;
...
public final class MessageHelper {
    ...
    public static void addWarningAttribute(ModelAndView model, String message, Object... args) {
    	addAttribute(model, message, Message.Type.WARNING, args);
    }
